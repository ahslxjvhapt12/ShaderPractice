...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        RaycastHit h;
        Physics.Raycast(Camera.main.ScreenPointToRay(value), out h);
        Vector3 dir = transform.position - h.point;
        float degree = Mathf.Atan2(dir.x, dir.z) * Mathf.Rad2Deg;
        transform.rotation = Quaternion.Euler(new Vector2(0, degree + 180));
    }
